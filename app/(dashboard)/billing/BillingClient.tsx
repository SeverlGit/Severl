...
const plans: PlanCard[] = [
  {
    ...
    name: 'Essential',
    price: 'Free',
    description: 'Get started and validate your workflow',
    features: [
      '5 clients',
      '25 deliverables / month',
      '500 MB storage',
      '3 brand guide shares / month',
  ...
  },
  {
    ...
    price: '$29',
    period: '/mo',
    description: 'For growing freelancers ready to look professional',
    features: [
      '15 clients',
      '150 deliverables / month',
      '10 GB storage',
      'Unlimited brand guide shares',
  ...
  },
  {
    ...
    price: '$79',
    period: '/mo',
    description: 'For busy freelancers who want to automate everything',
    features: [
      'Unlimited clients',
      'Unlimited deliverables',
      '100 GB storage',
      'White-label approval pages',
  ...
  },
  {
    ...
    price: '$99',
    period: '/mo',
    description: 'For scaling agencies with teams and client portals',
    features: [
      'Unlimited clients',
      'Unlimited deliverables',
      '500 GB storage',
      'Client portal',
      'Team management ($19/seat)',
      'All Elite features',
      'Premium support',
    ],
  },
